...
const universities = ['All', 'Pokhara University', 'Tribhuvan University', 'Kathmandu University', 'Purbanchal University'];
...
const UserManagement = () => {
  ...
  const filteredUsers = initialUsers.filter((user) => {
    const matchesUniversity =
      ...
      (user.contactInfo.university && user.contactInfo.university === selectedUniversity);
    const matchesSearch =
