    ...
    <div>
      <Dialog open={createclassDialog} onOpenChange={setcreateclassDialog}>
        ...
        <DialogContent>
          ...
          <span className="text-gray-700 font-bold">Enter ClassRoom Name:</span>
          <Input
            type="text"
            name="classroomname"
            id="classroomname"
          ...
          <Select>
            ...
            <SelectContent className="max-h-[160px] overflow-y-auto">
              ...
              <SelectItem value="pu">Purbanchal University (PU)</SelectItem>
              <SelectItem value="mu">Manipal University (MU)</SelectItem>
              <SelectItem value="ru">Pokhara University (PU)</SelectItem>
              <SelectItem value="lu">
                Lumbini Buddhist University (LBU)
              </SelectItem>
              <SelectItem value="bu">Buddha University (BU)</SelectItem>
              <SelectItem value="nepal">
                Nepal Sanskrit University (NSU)
              </SelectItem>
              <SelectItem value="cdu">
                Central Department of Education (CDE) - Tribhuvan University
              </SelectItem>
              <SelectItem value="sdu">Shree Harsha University (SHU)</SelectItem>
