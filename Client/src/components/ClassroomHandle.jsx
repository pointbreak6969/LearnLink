...
const ClassroomHandle = () => {
    const [classrooms, setClassrooms] = useState([
        { id: 1, name: "Math 101", code: "MATH101", requests: ["John Doe", "Jane Smith"], resources: [{ id: 1, title: "Math Resource", approved: false }] },
        { id: 2, name: "History 202", code: "HIST202", requests: ["Alice Johnson"], resources: [] }
      ]);
              ...
              <CardContent>
                <div className="flex items-center mb-4">
                  <Input
                    ...
                    className="mr-2"
                  />
                  <Button className="bg-[#926322] text-white hover:bg-[#E68600] transition-all duration-300 hover:scale-105">
