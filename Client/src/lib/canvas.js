...
import { defaultNavElement } from "./constants.js";
import { createSpecificShape } from "./shapes.js";
// initialize fabric canvas
export const initializeFabric = ({ fabircRef, canvasRef }) => {
  // get canvas element
  ...
  fabircRef.current = canvas;
  return canvas;
};
// instantiate creation of custom fabric object/shape and add it to canvas
export const handleCanasMouseDown = ({
  options,
  canvas,
  selectedShapeRef,
  isDrawing,
