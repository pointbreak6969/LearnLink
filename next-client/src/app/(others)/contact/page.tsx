  ...
  return (
    <>
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        >
          <div>
            <h1 className="text-4xl font-bold mb-6 text-[#FF9500]">page Us</h1>
            {!isSubmitted ? (
          ...
          <div className="space-y-6">
            ...
            >
              <h2 className="text-2xl font-semibold mb-4">
                Welcome to LearnLink's page Page
              </h2>
              <p>
                We're here to assist you with any questions or feedback
                regarding our educational notes and resources sharing platform.
                Whether you're a student looking for study materials or an
                educator wanting to share your knowledge, we're excited to hear
                from you.
              </p>
            </motion.div>
